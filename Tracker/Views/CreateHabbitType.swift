...
final class CreateHabitTypeViewController: UIViewController {
    ...
    private let habitButton: UIButton = {
        ...
        button.addTarget(CreateHabitTypeViewController.self, action: #selector(habitButtonTapped), for: .touchUpInside)
    ...
    private let irregularEventButton: UIButton = {
        ...
        button.backgroundColor = UIColor.custom(.createButtonColor)
        button.layer.cornerRadius = 16
        button.addTarget(CreateHabitTypeViewController.self, action: #selector(irregularEventButtonTapped), for: .touchUpInside)
        button.clipsToBounds = true
        return button
    }()
    ...
    private func setupUI() {
        ...
        @objc private func habitButtonTapped() {
               let habitSettingsVC = HabitSettingsViewController() // или другой VC
               navigationController?.pushViewController(habitSettingsVC, animated: true)
           }
